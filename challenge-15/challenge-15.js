(function(){
  ...
  */
  ...
  var renato = new Person('Renato', 'Siqueira', 37);
  var joao = new Person('João', 'Silva', 12);
  var lucas = new Person('Lucas', 'Silvano', 07);
  console.log(renato);
  console.log(joao);
  console.log(lucas);
  ...
  */
  ...
  console.log(lucas.getFullName() + ' agora tem ' + lucas.addAge(-5).getAge() + ' anos.');
