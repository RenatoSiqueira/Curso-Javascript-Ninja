(function (){
    ...
    */
    const result = sum( function ( num1, num2 ) {
     return num1 + num2 
    })
    ...
    */
    const subtraction = calculator( 10, 20 );
    const multiplication = calculator( 30, 40 );
    const division = calculator( 50,60 );
    const mod = calculator( 70,80 );
