(function() {
    ...
    */
    ...
    console.log( text.replace(/Manuel Marques de Sousa/, 'Renato Siqueira') )
    ...
    */
    ...
    console.log( text.replace(/brasileiro/, 'paraense') )
    ...
    */
    ...
    function getMonthNumber(nomeMonth){
        var meses = [
            'janeiro', 
            'fevereiro', 
            'março', 
        ...
        var numberMonth =  meses.indexOf(nomeMonth) + 1
        return numberMonth.toString().length < 2 ? '0' + numberMonth : numberMonth
    }
    ...
    */
    console.log( '\nReplace de datas:' );
    function replaceDate(regex, $1, $2, $3){
        return $1 + '/' + getMonthNumber($2) + '/' + $3
    }
